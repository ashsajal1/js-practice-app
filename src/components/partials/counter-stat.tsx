...
export default function CounterStat() {
    return (
        <div className="flex items-center dark:text-white">
            ...
            <div className="flex flex-col gap-2 justify-center items-center p-4 shadow dark:shadow-white dark:shadow-sm bg-white rounded dark:bg-black">
            ...
            <div className="flex flex-col gap-2 justify-center items-center p-4 shadow dark:shadow-white dark:shadow-sm bg-white dark:bg-black">

...
const projects = [
  ...
  },
  {
    ...
    url: 'https://github.com/ashsajal1?tab=repositories&q=python',
    description: 'Python scripts and utilities'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">About JS Practice</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
              A comprehensive platform for practicing JavaScript and other programming languages through interactive coding challenges and interview questions.
              Developed with ❤️ by Ashfiquzzaman Sajal.
            </p>
          ...
          >
            ...
            <ul className="space-y-3">
              {['Home', 'Interview', 'Practice', 'Roadmap', 'Blog'].map((item, index) => (
                <motion.li
                  key={item}
          ...
          >
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Featured Projects</h3>

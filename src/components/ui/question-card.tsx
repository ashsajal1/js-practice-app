...
export default function QuestionCard({ question, answer, id }: { question: string, answer: string, id: number }) {
    return (
        <div data-aos='fade-up' className="flex flex-col rounded p-4 border dark:border-gray-700 w-full md:min-w-[250px] md:max-w-[400px] bg-white dark:bg-black dark:text-white">

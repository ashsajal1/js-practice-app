...
export default function Button({ children, variant = "solid", ...props }: PropsWithChildren<ButtonProps>) {
    ...
    const buttonStyles = "p-2 rounded text-white flex items-center justify-center cursor-pointer select-none border";
    ...
    const outlineStyle = "border border-blue-600 dark:border-blue-800 text-blue-600 hover:bg-blue-700 hover:text-white bg-opacity-90 backdrop-blur-xl"

...
import InterviewPageSeo from '../components/seo/interview-page-seo';
...
export default function Interview() {
    ...
    return (
        <div className="p-4 w-full">
            <InterviewPageSeo title = "Programming Interview Practice | Rust, JavaScript, Go, React, Vue, and More" />
            ...
            <div className="flex items-center justify-center w-full py-24">
                {messages.length === 0 && <div>
                    <select value={langTopic} onChange={(e) => setLangTopic(e.target.value)} className='p-3 bg-darkText rounded outline-none w-full dark:border dark:border-gray-700 dark:bg-darkColor mb-2 dark:text-darkText' title='select language'>
